!(function (e, t) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : t(
        ((e =
          'undefined' != typeof globalThis ? globalThis : e || self).idb = {}),
      )
})(this, function (e) {
  'use strict'
  let t, n
  ...
  function d(e) {
    return e !== IDBDatabase.prototype.transaction ||
      ...
      ? (
        ...
        ? function (...t) {
            return e.apply(p(this), t), f(r.get(this))
          }
        : function (...t) {
  ...
  ;(c = ((e) => ({
    ...
    (e.deleteDB = function (e, { blocked: t } = {}) {
      ...
      return t && n.addEventListener('blocked', () => t()), f(n).then(() => {})
    }),
    (e.openDB = function (
      e,
      t,
      ...
      return (
        r &&
          i.addEventListener('upgradeneeded', (e) => {
            r(f(i.result), e.oldVersion, e.newVersion, f(i.transaction))
          }),
