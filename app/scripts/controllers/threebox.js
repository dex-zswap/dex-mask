...
import createOriginMiddleware from '@app/scripts/lib/createOriginMiddleware';
import createDexmaskMiddleware from './network/createDexmaskMiddleware';
...
export default class ThreeBoxController {
  ...
  _createProvider(providerOpts) {
    const metamaskMiddleware = createDexmaskMiddleware(providerOpts);
