...
import { getCurrentLocaleMessages, getEnLocaleMessages } from '@reducer/locale/locale';
...
export const I18nProvider = props => {
  ...
  const t = useMemo(() => {
    return (key, ...args) => getMessage(currentLocale, current, key, ...args) || getMessage(currentLocale, en, key, ...args);
