export const GO_HOME = 'GO_HOME' // modal state

export const MODAL_OPEN = 'UI_MODAL_OPEN'
export const MODAL_CLOSE = 'UI_MODAL_CLOSE' // sidebar state

export const SIDEBAR_OPEN = 'UI_SIDEBAR_OPEN'
export const SIDEBAR_CLOSE = 'UI_SIDEBAR_CLOSE' // alert state

export const ALERT_OPEN = 'UI_ALERT_OPEN'
export const ALERT_CLOSE = 'UI_ALERT_CLOSE'
export const QR_CODE_DETECTED = 'UI_QR_CODE_DETECTED' // network dropdown open

export const NETWORK_DROPDOWN_OPEN = 'UI_NETWORK_DROPDOWN_OPEN'
export const NETWORK_DROPDOWN_CLOSE = 'UI_NETWORK_DROPDOWN_CLOSE' // remote state

export const UPDATE_DEXMASK_STATE = 'UPDATE_DEXMASK_STATE'
...
export const CLOSE_WELCOME_SCREEN = 'CLOSE_WELCOME_SCREEN' // unlock screen
...
export const LOCK_DEXMASK = 'LOCK_DEXMASK' // error handling

export const DISPLAY_WARNING = 'DISPLAY_WARNING'
export const HIDE_WARNING = 'HIDE_WARNING'
export const CAPTURE_SINGLE_EXCEPTION = 'CAPTURE_SINGLE_EXCEPTION' // accounts screen

export const SHOW_ACCOUNT_DETAIL = 'SHOW_ACCOUNT_DETAIL'
export const SHOW_ACCOUNTS_PAGE = 'SHOW_ACCOUNTS_PAGE'
export const SHOW_CONF_TX_PAGE = 'SHOW_CONF_TX_PAGE' // account detail screen
...
export const CLEAR_ACCOUNT_DETAILS = 'CLEAR_ACCOUNT_DETAILS' // tx conf screen

export const COMPLETED_TX = 'COMPLETED_TX'
export const TRANSACTION_ERROR = 'TRANSACTION_ERROR'
export const UPDATE_TRANSACTION_PARAMS = 'UPDATE_TRANSACTION_PARAMS'
export const SET_NEXT_NONCE = 'SET_NEXT_NONCE' // config screen
...
export const SET_HARDWARE_WALLET_DEFAULT_HD_PATH =
  'SET_HARDWARE_WALLET_DEFAULT_HD_PATH' // loading overlay
...
export const TOGGLE_ACCOUNT_MENU = 'TOGGLE_ACCOUNT_MENU' // preferences
...
export const SET_PARTICIPATE_IN_METAMETRICS = 'SET_PARTICIPATE_IN_METAMETRICS' // locale

export const SET_CURRENT_LOCALE = 'SET_CURRENT_LOCALE' // Feature Flags

export const UPDATE_FEATURE_FLAGS = 'UPDATE_FEATURE_FLAGS' // Preferences

export const UPDATE_PREFERENCES = 'UPDATE_PREFERENCES' // Onboarding

export const COMPLETE_ONBOARDING = 'COMPLETE_ONBOARDING'
export const SET_MOUSE_USER_STATE = 'SET_MOUSE_USER_STATE' // Network
...
export const SET_OPEN_DEXMASK_TABIDS = 'SET_OPEN_DEXMASK_TABIDS' // Home Screen

export const HIDE_WHATS_NEW_POPUP = 'HIDE_WHATS_NEW_POPUP'
export const TOGGLE_GAS_LOADING_ANIMATION = 'TOGGLE_GAS_LOADING_ANIMATION' //  Cross Chain

export const UPDATE_CROSS_CHAIN_STATE = 'UPDATE_CROSS_CHAIN_STATE'
export const TOGGLE_GAS_LOADING = 'TOGGLE_GAS_LOADING'
export const UPDATE_CONFIRM_ACTION = 'UPDATE_CONFIRM_ACTION'
