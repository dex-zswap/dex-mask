...
export default class ConfirmDecryptMessage extends Component {
  ...
  renderHeader = () => {
    return <div className="request-decrypt-message__header">
  ...
  renderAccount = () => {
    ...
    return <div className="request-decrypt-message__account">
  ...
  renderBalance = () => {
    ...
    return <div className="request-decrypt-message__balance">
  ...
  renderRequestIcon = () => {
    ...
    return <div className="request-decrypt-message__request-icon">
        <Identicon diameter={40} address={requesterAddress} />
      </div>;
  };
  renderAccountInfo = () => {
    return <div className="request-decrypt-message__account-info">
        {this.renderAccount()}
  ...
  renderBody = () => {
    ...
    return <div className="request-decrypt-message__body">
        {this.renderAccountInfo()}
        <div className="request-decrypt-message__visual">
          <section>
            {originMetadata?.icon ? <img className="request-decrypt-message__visual-identicon" src={originMetadata.icon} alt="" /> : <i className="request-decrypt-message__visual-identicon--default">
        ...
        {hasDecrypted ? <div className={classnames({
        'request-decrypt-message__message-copy': true,
        'request-decrypt-message__message-copy--pressed': copyToClipboardPressed
      })} onClick={() => this.copyMessage()} onMouseDown={() => this.setState({
        copyToClipboardPressed: true
      })} onMouseUp={() => this.setState({
        copyToClipboardPressed: false
      })}>
            <Tooltip position="bottom" title={hasCopied ? t('copiedExclamation') : t('copyToClipboard')} wrapperClassName="request-decrypt-message__message-copy-tooltip" style={{
          display: 'flex',
          alignItems: 'center'
        }}>
  ...
  renderFooter = () => {
    ...
    return <div className="request-decrypt-message__footer">
        <Button type="default" large className="request-decrypt-message__footer__cancel-button" onClick={async event => {
        this._removeBeforeUnload();
        ...
        <Button type="secondary" large className="request-decrypt-message__footer__sign-button" onClick={async event => {
        this._removeBeforeUnload();
  ...
  render = () => {
    return <div className="request-decrypt-message__container">
        {this.renderHeader()}
        {this.renderBody()}
        {this.renderFooter()}
      </div>;
