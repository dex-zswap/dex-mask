...
const ToggleArrows = () => <svg width="6" height="9" viewBox="0 0 6 9" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default function SortList({
  ...
  return <div className="select-quote-popover__sort-list">
      <div className="select-quote-popover__column-headers">
        <div className="select-quote-popover__column-header select-quote-popover__receiving" onClick={() => onColumnHeaderClick('destinationTokenValue')}>
          ...
          <div className="select-quote-popover__receiving-label">
            ...
            <InfoTooltip position="bottom" contentText={t('swapReceivingInfoTooltip')} />
            <ToggleArrows />
          </div>
        </div>
        <div className="select-quote-popover__column-header select-quote-popover__network-fees select-quote-popover__network-fees-header" onClick={() => onColumnHeaderClick('rawNetworkFees')}>
          <span>{t('swapEstimatedNetworkFees')}</span>
          <InfoTooltip position="bottom" contentText={t('swapEstimatedNetworkFeesInfo')} />
          <ToggleArrows />
        </div>
        <div className="select-quote-popover__column-header select-quote-popover__quote-source" onClick={() => onColumnHeaderClick('quoteSource')}>
          {t('swapQuoteSource')}
      ...
      quoteSource,
      aggId
    }, i) => <div className={classnames('select-quote-popover__row', {
      'select-quote-popover__row--selected': selectedRow === i,
      'select-quote-popover__row--no-hover': noRowHover
    })} onClick={() => onSelect(aggId)} key={`select-quote-popover-row-${i}`}>
            <div className="select-quote-popover__receiving">
              <div className="select-quote-popover__receiving-value">
                ...
                <div className="select-quote-popover__receiving-value-text" title={destinationTokenValue}>
                  {destinationTokenValue}
                </div>
              </div>
              {quoteSource === 'RFQ' && <span className="select-quote-popover__zero-slippage">
                  {t('swapZeroSlippage')}
                </span>}
            </div>
            ...
            <div className="select-quote-popover__quote-source">
              <div className={classnames('select-quote-popover__quote-source-label', {
          ...
          'select-quote-popover__quote-source-label--blue': quoteSource === 'DEX'
            ...
            <div className="select-quote-popover__caret-right" onClick={event => {
        event.stopPropagation();
        onCaretClick(aggId);
      }} onMouseEnter={() => setRowNowHover(true)} onMouseLeave={() => setRowNowHover(false)}>
