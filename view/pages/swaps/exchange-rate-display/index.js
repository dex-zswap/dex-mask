...
export default function ExchangeRateDisplay({
  ...
  return <div className={classnames('exchange-rate-display', className)}>
      <span>1</span>
      ...
      <div className={classnames('exchange-rate-display__switch-arrows', {
