    ...
    return <div className={classnames('ens-input', className)}>
        ...
        'ens-input__wrapper--valid': hasSelectedAddress
          ...
          {hasSelectedAddress ? <>
              ...
              <input className="ens-input__wrapper__input" type="text" dir="auto" placeholder={t('recipientAddressPlaceholder2')} onChange={this.onChange} onPaste={this.onPaste} value={selectedAddress || userInput} data-testid="ens-input" />
