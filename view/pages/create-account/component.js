...
export default class NewAccountCreateForm extends Component {
  ...
  render() {
    ...
    return (
      <div className="new-account-create-form dex-page-container space-between base-width">
        <>
          <div className="new-account-form-top">
            ...
            <div className="new-account-create-form__input-container">
              <TextField
                ...
                label={this.context.t('accountName')}
          ...
          <div className="new-account-create-form__buttons flex space-between">
            <Button
              className="new-account-create-form__button half-button"
