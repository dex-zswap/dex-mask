...
class AccountList extends Component {
  ...
  renderHdPathSelector() {
    ...
    return <div>
        ...
        <div className="hw-connect__hdPath">
          <Dropdown className="hw-connect__hdPath__select" options={hdPaths} selectedOption={pathValue || selectedPath} onChange={value => {
          this.setPath(value);
        }} />
        </div>
      </div>;
  ...
  renderHeader() {
    return <div className="hw-connect">
        ...
        <p className="hw-connect__msg">
          ...
          {this.context.t('selectAnAccountHelpDirections', [<button className="hw-connect__msg-link" onClick={() => this.setState({
          showPopover: true
        })} key="account-help">
  ...
  renderAccounts() {
    ...
    return <div className="hw-account-list">
        ...
        return <div className="hw-account-list__item" key={account.address} title={accountAlreadyConnected ? this.context.t('selectAnAccountAlreadyConnected') : ''}>
              <div className="hw-account-list__item__checkbox">
                <Checkbox id={`address-${idx}`} checked={checked} disabled={accountAlreadyConnected} onClick={() => {
              ...
              <a className="hw-account-list__item__link" onClick={() => {
            let accountLink = getAccountLink(account.address, chainId, rpcPrefs);

            if (!accountLink && CHAINID_EXPLORE_MAP[chainId]) {
              accountLink = createCustomAccountLink(account.address, CHAINID_EXPLORE_MAP[chainId]);
            }

            global.platform.openTab({
              url: accountLink
            });
          }} target="_blank" rel="noopener noreferrer" title={this.context.t('etherscanView')}>
  ...
  renderPagination() {
    return <div className="hw-list-pagination">
  ...
  renderButtons() {
    ...
    return <div className="new-external-account-form__buttons">
        <Button type="default" large className="new-external-account-form__button" onClick={this.props.onCancel.bind(this)}>
          {this.context.t('cancel')}
        </Button>
        <Button type="primary" large className="new-external-account-form__button unlock" disabled={disabled} onClick={this.props.onUnlockAccounts.bind(this, this.props.device, this.props.selectedPath)}>
  ...
  renderForgetDevice() {
    return <div className="hw-forget-device-container">
  ...
  renderSelectPathPopover() {
    ...
    const footer = <div className="switch-ledger-path-popover__footer">
    ...
    return <Popover title={this.context.t('switchLedgerPaths')} subtitle={this.context.t('switchLedgerPathsText')} contentClassName="switch-ledger-path-popover__content" footer={footer}>
  ...
  render() {
    ...
    return <div className="new-external-account-form account-list">
        {this.renderHeader()}
        {this.renderAccounts()}
