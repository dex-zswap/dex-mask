...
export default class TokenList extends Component {
  ...
  render() {
    ...
    return results.length === 0 ? null : <div className="token-list">
        ...
        <div className="token-list__tokens-container">
          ...
          return Boolean(logo || symbol || name) && <div className={classnames('token-list__token', {
            'token-list__token--selected': selectedTokens[address],
            'token-list__token--disabled': tokenAlreadyAdded
          })} onClick={onClick} onKeyPress={event => event.key === 'Enter' && onClick()} key={i} tabIndex="0">
                    <div className="token-list__token-icon" style={{
