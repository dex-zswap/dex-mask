...
class Switchers extends React.Component {
  ...
  renderNetrowkSwitcher() {
    ...
    return (
      <div
        ...
        ref={(element) => (this.networkSwitchRef = element)}
        onClick={this.toggleSwitchNetwork}
      >
  ...
  renderAccountSwitcher() {
    ...
    return (
      <div
        className="switcher-bar"
        onClick={this.toggleSwitchAccount}
        ref={(element) => (this.accountSwitchRef = element)}
      >
        <div className="switcher-text" title={name}>
          {display}
        </div>
  ...
  renderAccountMenu() {
    ...
    return (
      <Menu
        ...
        className="switcher__account-menu"
        onHide={this.toggleSwitchAccount}
      >
          ...
          >
            <div className="switcher__account-menu__row">
              ...
              {address === account.address && (
                <div className="account-checked"></div>
              )}
            </div>
          </MenuItem>
        ))}
  ...
  render() {
    return (
      <div className="asset__switchers">
