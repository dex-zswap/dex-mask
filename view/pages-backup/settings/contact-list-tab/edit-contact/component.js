...
export default class EditContact extends PureComponent {
  ...
  render() {
    ...
    return <div className="settings-page__content-row address-book__edit-contact">
        <div className="settings-page__header address-book__header--edit">
          <Identicon address={address} diameter={60} />
          {showingMyAccounts ? null : <Button type="link" className="settings-page__address-book-button" onClick={async () => {
        ...
        <div className="address-book__edit-contact__content">
          <div className="address-book__view-contact__group">
            ...
            <TextField type="text" id="nickname" placeholder={this.context.t('addAlias')} value={this.state.newName} onChange={e => this.setState({
          ...
          <div className="address-book__view-contact__group">
            ...
            <TextField type="text" id="address" value={this.state.newAddress} error={this.state.error} onChange={e => this.setState({
          ...
          <div className="address-book__view-contact__group">
            ...
            <TextField type="text" id="memo" placeholder={memo} value={this.state.newMemo} onChange={e => this.setState({
            newMemo: e.target.value
          })} fullWidth margin="dense" multiline rows={3} classes={{
            inputMultiline: 'address-book__view-contact__text-area',
            inputRoot: 'address-book__view-contact__text-area-wrapper'
          }} />
          </div>
        </div>
        <PageContainerFooter cancelText={this.context.t('cancel')} onSubmit={async () => {
        if (this.state.newAddress !== '' && this.state.newAddress !== address) {
          ...
          if (!isBurnAddress(this.state.newAddress) && isValidHexAddress(this.state.newAddress, {
