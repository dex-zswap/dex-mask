...
const AlertSettingsEntry = ({
  ...
  return <>
      ...
      <Tooltip position="top" title={description} wrapperClassName="alerts-tab__description">
        <img className="info-icon" width="12px" src="images/dex/info.png" />
        {
        /* <i className="fa fa-info-circle" /> */
      }
      </Tooltip>
      <ToggleButton offLabel={t('off')} onLabel={t('on')} onToggle={() => setAlertEnabledness(alertId, !isEnabled)} value={isEnabled} />
    </>;
};
...
const AlertsTab = () => {
  ...
  return <div className="alerts-tab__body">
