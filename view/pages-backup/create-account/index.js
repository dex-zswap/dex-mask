...
import { NEW_ACCOUNT_ROUTE, IMPORT_ACCOUNT_ROUTE, CONNECT_HARDWARE_ROUTE } from '@view/helpers/constants/routes';
    ...
    return <div className="new-account">
        <div className="new-account__form">
          <Switch>
            ...
            <Route exact path={CONNECT_HARDWARE_ROUTE} component={ConnectHardwareForm} />
          </Switch>
        </div>
      </div>;
  }
