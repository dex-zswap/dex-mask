...
import { getAllState, getCurrentChainId, getDexMaskAccountsOrdered, getSelectedAccount, getSelectedIdentity } from '@view/selectors';
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    updateCrossChainState: value => dispatch(actions.updateCrossChainState(value)),
    updateSendAsset: value => dispatch(actions.updateSendAsset(value)),
    updateRecipient: value => dispatch(updateRecipient(value))
  };
};

export default withRouter(connect(mapStateToProps, mapDispatchToProps)(ReciveToken));