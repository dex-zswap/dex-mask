...
export default function SwapsFooter({
  ...
  return <div className="swaps-footer">
      <div className={classnames('swaps-footer__buttons', className, {
      'swaps-footer__buttons--border': showTopBorder
    })}>
        <PageContainerFooter onCancel={onCancel} hideCancel={hideCancel} cancelText={t('back')} onSubmit={onSubmit} submitText={submitText} submitButtonType="confirm" footerClassName={classnames('swaps-footer__custom-page-container-footer-class', className)} footerButtonClassName={classnames('swaps-footer__custom-page-container-footer-button-class', {
        'swaps-footer__custom-page-container-footer-button-class--single': hideCancel
      })} disabled={disabled} />
      </div>
      {showTermsOfService && <div className="swaps-footer__bottom-text" onClick={() => global.platform.openTab({
