...
export default function ViewOnEtherScanLink({
  ...
  return <div className={classnames('awaiting-swap__view-on-etherscan', {
    ...
    global.platform.openTab({
      ...
      {isCustomBlockExplorerUrl ? t('viewOnCustomBlockExplorer', [new URL(blockExplorerUrl).hostname]) : t('viewOnEtherscan')}
    </div>;
}
