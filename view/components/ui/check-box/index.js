...
const CheckBox = ({
  ...
  return <input checked={checked === CHECKBOX_STATE.CHECKED} className={classnames('check-box', className, {
  ...
  })} disabled={disabled} id={id} onClick={onClick ? event => {
    event.preventDefault();
    onClick();
  } : null} readOnly ref={ref} title={title} type="checkbox" />;
};
