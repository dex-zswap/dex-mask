...
const TextField = ({
  ...
  return <div className={classnames('dex-text-field', className)}>
      {React.isValidElement(label) ? label : <label className={classnames('dex-text-field-label', `${className}-label`)}>
          {label}
        </label>}
