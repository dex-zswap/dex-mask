...
import { ENVIRONMENT_TYPE_NOTIFICATION, MESSAGE_TYPE } from '@shared/constants/app';
...
export default class SignatureRequestOriginal extends Component {
  ...
  renderOriginInfo = () => {
    ...
    const originMetadata = txData.msgParams.origin ? domainMetadata?.[txData.msgParams.origin] : null;
    return <div className="request-signature__origin-row">
        <div className="request-signature__origin-label">
          {`${t('origin')}:`}
        </div>
        {originMetadata?.icon ? <SiteIcon icon={originMetadata.icon} name={originMetadata.hostname} size={24} /> : null}
  ...
  renderBody = () => {
    ...
    return <div className="request-signature__body">
        ...
        'request-signature__warning': type === MESSAGE_TYPE.ETH_SIGN
          ...
          {notice}
          {type === MESSAGE_TYPE.ETH_SIGN ? <span className="request-signature__help-link" onClick={() => {
        ...
        <div className="request-signature__rows">
          ...
          return <div className="request-signature__row" key={`request-signature-row-${index}`}>
  ...
  renderFooter = () => {
    ...
    return <div className="request-signature__footer">
        <Button type="default" large className="request-signature__footer__cancel-button" onClick={async event => {
        this._removeBeforeUnload();
        ...
        <Button data-testid="request-signature__sign" type="secondary" large className="request-signature__footer__sign-button" onClick={async event => {
        this._removeBeforeUnload();
