...
export default class DepositEtherModal extends Component {
  ...
  renderRow({
    ...
    return <div className={className || 'deposit-ether-modal__buy-row'}>
        {onBackClick && showBackButton && <div className="deposit-ether-modal__buy-row__back" onClick={onBackClick}>
        ...
        <div className="deposit-ether-modal__buy-row__description">
          {!hideTitle && <div className="deposit-ether-modal__buy-row__description__title">
              {title}
            </div>}
        ...
        {!hideButton && <div className="deposit-ether-modal__buy-row__button">
            <Button type="secondary" className="deposit-ether-modal__deposit-button" large onClick={onButtonClick}>
              {buttonLabel}
            </Button>
          </div>}
      </div>;
  ...
  render() {
    ...
    return <div className="page-container page-container--full-width page-container--full-height">
        <div className="page-container__header">
          ...
          <div className="page-container__header-close" onClick={() => {
          this.props.hideWarning();
          this.props.hideModal();
        }} />
        </div>
        <div className="page-container__content">
          <div className="deposit-ether-modal__buy-rows">
            {this.renderRow({
            logo: <div className="deposit-ether-modal__logo" style={{
            ...
            {this.renderRow({
            logo: <img alt="" className="deposit-ether-modal__logo" src="./images/deposit-eth.svg" style={{
              height: '75px',
              width: '75px'
            }} />,
