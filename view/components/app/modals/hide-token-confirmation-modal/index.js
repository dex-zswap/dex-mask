...
class HideTokenConfirmationModal extends Component {
  ...
  render() {
    ...
    return <div className="hide-token-confirmation">
        <div className="hide-token-confirmation__container">
          ...
          <Identicon className="hide-token-confirmation__identicon" diameter={45} address={address} image={image} />
          ...
          <div className="hide-token-confirmation__buttons">
            <Button type="default" className="hide-token-confirmation__button" data-testid="hide-token-confirmation__cancel" onClick={() => hideModal()}>
              {this.context.t('cancel')}
            </Button>
            <Button type="secondary" className="hide-token-confirmation__button" data-testid="hide-token-confirmation__hide" onClick={() => hideToken(address)}>
              {this.context.t('hide')}
            </Button>
          </div>
        </div>
