...
export default class RejectTransactionsModal extends PureComponent {
  ...
  render() {
    ...
    return <Modal headerText={t('rejectTxsN', [unapprovedTxCount])} onClose={hideModal} onSubmit={this.onSubmit} onCancel={hideModal} submitText={t('rejectAll')} cancelText={t('cancel')} submitType="secondary">
        <div>
