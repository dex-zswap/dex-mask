...
class FadeModal extends Component {
  ...
  render() {
    ...
    const backdrop = this.props.backdrop ? <div className="modal__backdrop" style={backdropStyle} onClick={this.props.closeOnClick ? this.handleBackdropClick : null} /> : undefined;
    ...
    return <span>
        <div className="modal" style={modalStyle}>
          <div className="modal__content" ref={el => this.content = el} tabIndex="-1" style={contentStyle}>
            {this.props.children}
          </div>
        </div>
        {backdrop}
