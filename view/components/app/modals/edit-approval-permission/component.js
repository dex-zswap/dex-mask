...
export default class EditApprovalPermission extends PureComponent {
  ...
  renderModalContent(error) {
    ...
    return <div className="edit-approval-permission">
        <div className="edit-approval-permission__header">
          <div className="edit-approval-permission__title">
            {t('editPermission')}
          </div>
          <div className="edit-approval-permission__header__close" onClick={() => hideModal()} />
        </div>
        ...
        <div className="edit-approval-permission__edit-section">
          ...
          <div className="edit-approval-permission__edit-section__option">
            <div className="edit-approval-permission__edit-section__radio-button" onClick={() => this.setState({
          ...
          <div className="edit-approval-permission__edit-section__option">
            ...
            <div className="edit-approval-permission__edit-section__option-text">
              ...
              <div className="edit-approval-permission__edit-section__option-input">
                <TextField type="number" placeholder={`${Number(customTokenAmount || tokenAmount)} ${tokenSymbol}`} onChange={event => {
                this.setState({
              ...
              }} fullWidth margin="dense" value={this.state.customSpendLimit} error={error} />
              </div>
            </div>
          </div>
        </div>
  ...
  render() {
    ...
    return <Modal onSubmit={() => {
      ...
      hideModal();
    }} submitText={t('save')} submitType="primary" contentClass="edit-approval-permission-modal-content" containerClass="edit-approval-permission-modal-container" submitDisabled={disabled}>
