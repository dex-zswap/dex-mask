...
import { TRANSACTION_CANCEL_ATTEMPTED_EVENT, TRANSACTION_CANCEL_SUCCESS_EVENT, TRANSACTION_CONFIRMED_EVENT, TRANSACTION_CREATED_EVENT, TRANSACTION_DROPPED_EVENT, TRANSACTION_ERRORED_EVENT, TRANSACTION_RESUBMITTED_EVENT, TRANSACTION_SUBMITTED_EVENT } from '@c/app/transaction/activity-log/constants';
const imageHash = {
...
export default class TransactionActivityLogIcon extends PureComponent {
  ...
  render() {
    ...
    return <div className={classnames('transaction-activity-log-icon', className)}>
