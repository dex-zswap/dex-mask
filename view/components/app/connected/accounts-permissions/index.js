...
export default class ConnectedAccountsPermissions extends PureComponent {
  ...
  render() {
    ...
    return <div className="connected-accounts-permissions">
        <p className="connected-accounts-permissions__header" onClick={this.toggleExpanded}>
          <strong>{t('permissions')}</strong>
          <button className={classnames('fas', {
          'fa-angle-down': !expanded,
          'fa-angle-up': expanded
        })} title={t('showPermissions')} />
        </p>
        <div className={classnames('connected-accounts-permissions__list-container', {
